...
void Articulo::setTipoArticulo(char *tipoarticulo)
{
    strcpy(_tipoArticulo, tipoarticulo);
}
void Articulo::setCaracteristicas(char *caracteristicas)
{
    strcpy(_caracteristicas, caracteristicas);
}
...
char *Articulo::getTipoArticulo()
{
    return _tipoArticulo;
}

char *Articulo::getCaracteristicas()
{
...
void Articulo::cargar()
{
    ...
    cin.ignore();
    cin.getline(_caracteristicas, 100);
    cout << "CATEGORIA: ";
    cin.getline(_tipoArticulo, 20);
    _estado = true;
...
void Articulo::mostrar()
{
    if(_estado==true)
    {
        ...
        cout << "CARACTERISTICAS: "<< _caracteristicas << endl;
        cout << "CATEGORIA: " << _tipoArticulo << endl;
